...
public class ChargedLimboEngineItem extends Item {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		ChargedLimboEngineItemInInventoryTickProcedure.execute(com.google.common.collect.ImmutableMap.<String, Object>builder().put("world", world).put("entity", entity).put("itemstack", itemstack).build());
	}
}
